...
class FORM_TYPE(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    FORM_TYPE_GENERAL_SETTINGS_FORM: _ClassVar[FORM_TYPE]
...
class FORM_FIELD_ELEMENT(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    FORM_FIELD_ELEMENT_URL: _ClassVar[FORM_FIELD_ELEMENT]
...
FORM_TYPE_GENERAL_SETTINGS_FORM: FORM_TYPE
...
FORM_FIELD_ELEMENT_URL: FORM_FIELD_ELEMENT

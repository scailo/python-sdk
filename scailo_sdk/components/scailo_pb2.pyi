...
class COMPONENT_REF_FROM(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    COMPONENT_REF_FROM_ANY_UNSPECIFIED: _ClassVar[COMPONENT_REF_FROM]
    COMPONENT_REF_FROM_INITIAL_STOCK: _ClassVar[COMPONENT_REF_FROM]
    COMPONENT_REF_FROM_GOODS_RECEIPT: _ClassVar[COMPONENT_REF_FROM]
    COMPONENT_REF_FROM_INWARD_JOB_FREE_ISSUE_MATERIAL: _ClassVar[COMPONENT_REF_FROM]
    COMPONENT_REF_FROM_OUTWARD_JOB_FREE_ISSUE_MATERIAL: _ClassVar[COMPONENT_REF_FROM]
    COMPONENT_REF_FROM_PRODUCTION_PLAN: _ClassVar[COMPONENT_REF_FROM]
COMPONENT_REF_FROM_ANY_UNSPECIFIED: COMPONENT_REF_FROM
COMPONENT_REF_FROM_INITIAL_STOCK: COMPONENT_REF_FROM
COMPONENT_REF_FROM_GOODS_RECEIPT: COMPONENT_REF_FROM
COMPONENT_REF_FROM_INWARD_JOB_FREE_ISSUE_MATERIAL: COMPONENT_REF_FROM
COMPONENT_REF_FROM_OUTWARD_JOB_FREE_ISSUE_MATERIAL: COMPONENT_REF_FROM
COMPONENT_REF_FROM_PRODUCTION_PLAN: COMPONENT_REF_FROM

class ComponentsServiceCreateRequest(_message.Message):
    __slots__ = ()
    ...
    def __init__(self, entity_uuid: _Optional[str] = ..., user_comment: _Optional[str] = ..., vault_folder_id: _Optional[int] = ..., ref_from: _Optional[_Union[COMPONENT_REF_FROM, str]] = ..., ref_id: _Optional[int] = ..., family_id: _Optional[int] = ..., internal_item_code: _Optional[str] = ..., quantity: _Optional[int] = ..., secondary_uom_id: _Optional[int] = ..., secondary_quantity: _Optional[int] = ..., shelf_life_timestamp: _Optional[int] = ..., warranty_timestamp: _Optional[int] = ..., location_id: _Optional[int] = ..., description: _Optional[str] = ..., form_data: _Optional[_Iterable[_Union[_scailo_pb2_1_1.FormFieldDatumCreateRequest, _Mapping]]] = ...) -> None: ...

class ComponentsServiceUpdateRequest(_message.Message):
    __slots__ = ()
    USER_COMMENT_FIELD_NUMBER: _ClassVar[int]
    ...
    description: str
    form_data: _containers.RepeatedCompositeFieldContainer[_scailo_pb2_1_1.FormFieldDatumCreateRequest]
    def __init__(self, user_comment: _Optional[str] = ..., id: _Optional[int] = ..., notify_users: _Optional[bool] = ..., vault_folder_id: _Optional[int] = ..., internal_item_code: _Optional[str] = ..., secondary_uom_id: _Optional[int] = ..., secondary_quantity: _Optional[int] = ..., shelf_life_timestamp: _Optional[int] = ..., warranty_timestamp: _Optional[int] = ..., storage_id: _Optional[int] = ..., is_qc_report_public: _Optional[bool] = ..., remaining_dimensions: _Optional[str] = ..., description: _Optional[str] = ..., form_data: _Optional[_Iterable[_Union[_scailo_pb2_1_1.FormFieldDatumCreateRequest, _Mapping]]] = ...) -> None: ...

class ComponentsServiceSendToStoreRequest(_message.Message):
    __slots__ = ()
    USER_COMMENT_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    SHELF_LIFE_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class Component(_message.Message):
    ...
    def __init__(self, entity_uuid: _Optional[str] = ..., metadata: _Optional[_Union[_scailo_pb2.EmployeeMetadata, _Mapping]] = ..., status: _Optional[_Union[_scailo_pb2.INVENTORY_LIFECYCLE, str]] = ..., logs: _Optional[_Iterable[_Union[_scailo_pb2.LogbookLogInventoryLC, _Mapping]]] = ..., store_intake_at: _Optional[int] = ..., consumed_or_rejected_at: _Optional[int] = ..., rework_start_at: _Optional[int] = ..., rework_end_at: _Optional[int] = ..., returned_or_scrapped_at: _Optional[int] = ..., discarded_at: _Optional[int] = ..., vault_folder_id: _Optional[int] = ..., parent_ref_id: _Optional[int] = ..., ref_from: _Optional[_Union[COMPONENT_REF_FROM, str]] = ..., ref_id: _Optional[int] = ..., family_id: _Optional[int] = ..., code: _Optional[str] = ..., internal_item_code: _Optional[str] = ..., hash: _Optional[str] = ..., quantity: _Optional[int] = ..., quantity_remaining: _Optional[int] = ..., secondary_uom_id: _Optional[int] = ..., secondary_quantity: _Optional[int] = ..., shelf_life_timestamp: _Optional[int] = ..., warranty_timestamp: _Optional[int] = ..., store_id: _Optional[int] = ..., storage_id: _Optional[int] = ..., is_qc_report_public: _Optional[bool] = ..., location_id: _Optional[int] = ..., remaining_dimensions: _Optional[str] = ..., description: _Optional[str] = ..., short_url: _Optional[str] = ..., form_data: _Optional[_Iterable[_Union[_scailo_pb2_1_1.FormFieldDatum, _Mapping]]] = ...) -> None: ...

class ComponentsList(_message.Message):
    __slots__ = ()
    LIST_FIELD_NUMBER: _ClassVar[int]
    list: _containers.RepeatedCompositeFieldContainer[Component]
    def __init__(self, list: _Optional[_Iterable[_Union[Component, _Mapping]]] = ...) -> None: ...

class ComponentsServicePaginationReq(_message.Message):
    __slots__ = ()
...
class ComponentsServicePaginationResponse(_message.Message):
    __slots__ = ()
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[Component]
    def __init__(self, count: _Optional[int] = ..., offset: _Optional[int] = ..., total: _Optional[int] = ..., payload: _Optional[_Iterable[_Union[Component, _Mapping]]] = ...) -> None: ...

class ComponentsServiceFilterReq(_message.Message):
    __slots__ = ()
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
...
class ComponentsServiceSearchAllReq(_message.Message):
    __slots__ = ()
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]

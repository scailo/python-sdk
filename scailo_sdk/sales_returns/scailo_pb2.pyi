...
class SalesReturnsServiceItemCreateRequest(_message.Message):
    __slots__ = ("user_comment", "sales_return_id", "family_id", "item_hash", "internal_quantity", "client_uom_id", "client_quantity")
    USER_COMMENT_FIELD_NUMBER: _ClassVar[int]
...
class SalesReturnsServiceItemUpdateRequest(_message.Message):
    __slots__ = ("user_comment", "id", "item_hash", "internal_quantity", "client_uom_id", "client_quantity")
    USER_COMMENT_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    ITEM_HASH_FIELD_NUMBER: _ClassVar[int]
    INTERNAL_QUANTITY_FIELD_NUMBER: _ClassVar[int]
...
class SalesReturnItem(_message.Message):
    __slots__ = ("entity_uuid", "metadata", "approval_metadata", "need_approval", "user_comment", "sales_return_id", "family_id", "item_hash", "internal_quantity", "client_uom_id", "client_quantity")
    ENTITY_UUID_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    APPROVAL_METADATA_FIELD_NUMBER: _ClassVar[int]
...
class SalesReturnItemHistoryRequest(_message.Message):
    __slots__ = ("sales_return_id", "family_id")
    SALES_RETURN_ID_FIELD_NUMBER: _ClassVar[int]
    FAMILY_ID_FIELD_NUMBER: _ClassVar[int]
    sales_return_id: int
    family_id: int
...
class SalesReturnItemsSearchRequest(_message.Message):
    __slots__ = ("is_active", "count", "offset", "sort_order", "sort_key", "entity_uuid", "status", "approved_on_start", "approved_on_end", "approved_by_user_id", "approver_role_id", "sales_return_id", "family_id", "item_hash", "client_uom_id", "search_key")
...
class SalesReturnsServiceFilterReq(_message.Message):
    __slots__ = ("is_active", "count", "offset", "sort_order", "sort_key", "creation_timestamp_start", "creation_timestamp_end", "modification_timestamp_start", "modification_timestamp_end", "entity_uuid", "status", "approved_on_start", "approved_on_end", "approved_by_user_id", "approver_role_id", "completed_on_start", "completed_on_end", "reference_id", "final_ref_number", "ref_from", "ref_id", "location_id", "billing_status", "family_id", "consignee_client_id", "buyer_client_id", "project_id", "form_data")
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    SORT_ORDER_FIELD_NUMBER: _ClassVar[int]

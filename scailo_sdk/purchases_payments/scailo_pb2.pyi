...
class PURCHASE_PAYMENT_SORT_KEY(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PURCHASE_PAYMENT_SORT_KEY_CREATED_AT: _ClassVar[PURCHASE_PAYMENT_SORT_KEY]
    PURCHASE_PAYMENT_SORT_KEY_MODIFIED_AT: _ClassVar[PURCHASE_PAYMENT_SORT_KEY]
    PURCHASE_PAYMENT_SORT_KEY_APPROVED_ON: _ClassVar[PURCHASE_PAYMENT_SORT_KEY]
    PURCHASE_PAYMENT_SORT_KEY_APPROVED_BY: _ClassVar[PURCHASE_PAYMENT_SORT_KEY]
    PURCHASE_PAYMENT_SORT_KEY_APPROVER_ROLE_ID: _ClassVar[PURCHASE_PAYMENT_SORT_KEY]
    PURCHASE_PAYMENT_SORT_KEY_COMPLETED_ON: _ClassVar[PURCHASE_PAYMENT_SORT_KEY]
...
PURCHASE_PAYMENT_SORT_KEY_APPROVED_ON: PURCHASE_PAYMENT_SORT_KEY
PURCHASE_PAYMENT_SORT_KEY_APPROVED_BY: PURCHASE_PAYMENT_SORT_KEY
PURCHASE_PAYMENT_SORT_KEY_APPROVER_ROLE_ID: PURCHASE_PAYMENT_SORT_KEY
PURCHASE_PAYMENT_SORT_KEY_COMPLETED_ON: PURCHASE_PAYMENT_SORT_KEY
PURCHASE_PAYMENT_SORT_KEY_REFERENCE_ID: PURCHASE_PAYMENT_SORT_KEY
PURCHASE_PAYMENT_SORT_KEY_FINAL_REF_NUMBER: PURCHASE_PAYMENT_SORT_KEY
...
class PurchasesPaymentsServicePaginationReq(_message.Message):
    ...
    sort_key: PURCHASE_PAYMENT_SORT_KEY
    status: _scailo_pb2.STANDARD_LIFECYCLE_STATUS
...
class PurchasesPaymentsServicePaginationResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[PurchasePayment]
...
class PurchasesPaymentsServiceSearchAllReq(_message.Message):
    ...
    search_key: str
    vendor_id: int
    def __init__(self, is_active: _Optional[_Union[_scailo_pb2.BOOL_FILTER, str]] = ..., count: _Optional[int] = ..., offset: _Optional[int] = ..., sort_order: _Optional[_Union[_scailo_pb2.SORT_ORDER, str]] = ..., sort_key: _Optional[_Union[PURCHASE_PAYMENT_SORT_KEY, str]] = ..., entity_uuid: _Optional[str] = ..., status: _Optional[_Union[_scailo_pb2.STANDARD_LIFECYCLE_STATUS, str]] = ..., search_key: _Optional[str] = ..., vendor_id: _Optional[int] = ...) -> None: ...

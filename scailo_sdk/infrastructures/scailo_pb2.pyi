...
class INFRASTRUCTURE_REF_FROM(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    INFRASTRUCTURE_REF_FROM_ANY_UNSPECIFIED: _ClassVar[INFRASTRUCTURE_REF_FROM]
    INFRASTRUCTURE_REF_FROM_INITIAL_STOCK: _ClassVar[INFRASTRUCTURE_REF_FROM]
    INFRASTRUCTURE_REF_FROM_GOODS_RECEIPT: _ClassVar[INFRASTRUCTURE_REF_FROM]
    INFRASTRUCTURE_REF_FROM_INWARD_JOB_FREE_ISSUE_MATERIAL: _ClassVar[INFRASTRUCTURE_REF_FROM]
INFRASTRUCTURE_REF_FROM_ANY_UNSPECIFIED: INFRASTRUCTURE_REF_FROM
INFRASTRUCTURE_REF_FROM_INITIAL_STOCK: INFRASTRUCTURE_REF_FROM
INFRASTRUCTURE_REF_FROM_GOODS_RECEIPT: INFRASTRUCTURE_REF_FROM
INFRASTRUCTURE_REF_FROM_INWARD_JOB_FREE_ISSUE_MATERIAL: INFRASTRUCTURE_REF_FROM

class InfrastructuresServiceCreateRequest(_message.Message):
    __slots__ = ()
    ...
    user_comment: str
    vault_folder_id: int
    ref_from: INFRASTRUCTURE_REF_FROM
    ref_id: int
    family_id: int
...
class InfrastructuresServiceSendToStoreRequest(_message.Message):
    __slots__ = ()
    USER_COMMENT_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    SHELF_LIFE_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class InfrastructuresServicePaginationResponse(_message.Message):
    __slots__ = ()
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[Infrastructure]
    def __init__(self, count: _Optional[int] = ..., offset: _Optional[int] = ..., total: _Optional[int] = ..., payload: _Optional[_Iterable[_Union[Infrastructure, _Mapping]]] = ...) -> None: ...

class InfrastructuresServiceFilterReq(_message.Message):
    __slots__ = ()
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
...
class InfrastructuresServiceSearchAllReq(_message.Message):
    __slots__ = ()
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]

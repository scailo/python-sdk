...
class STORAGE_SORT_KEY(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    STORAGE_SORT_KEY_ID_UNSPECIFIED: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_CREATED_AT: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_MODIFIED_AT: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_APPROVED_ON: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_APPROVED_BY: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_APPROVER_ROLE_ID: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_NAME: _ClassVar[STORAGE_SORT_KEY]
    STORAGE_SORT_KEY_CODE: _ClassVar[STORAGE_SORT_KEY]
STORAGE_SORT_KEY_ID_UNSPECIFIED: STORAGE_SORT_KEY
STORAGE_SORT_KEY_CREATED_AT: STORAGE_SORT_KEY
STORAGE_SORT_KEY_MODIFIED_AT: STORAGE_SORT_KEY
STORAGE_SORT_KEY_APPROVED_ON: STORAGE_SORT_KEY
STORAGE_SORT_KEY_APPROVED_BY: STORAGE_SORT_KEY
STORAGE_SORT_KEY_APPROVER_ROLE_ID: STORAGE_SORT_KEY
STORAGE_SORT_KEY_NAME: STORAGE_SORT_KEY
...
class StoragesServicePaginationResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[Storage]
...
class StoragesServiceSearchAllReq(_message.Message):
    ...
    is_leaf: _scailo_pb2.BOOL_FILTER
    family_id: int
    def __init__(self, is_active: _Optional[_Union[_scailo_pb2.BOOL_FILTER, str]] = ..., count: _Optional[int] = ..., offset: _Optional[int] = ..., sort_order: _Optional[_Union[_scailo_pb2.SORT_ORDER, str]] = ..., sort_key: _Optional[_Union[STORAGE_SORT_KEY, str]] = ..., entity_uuid: _Optional[str] = ..., status: _Optional[_Union[_scailo_pb2.STANDARD_LIFECYCLE_STATUS, str]] = ..., search_key: _Optional[str] = ..., store_id: _Optional[int] = ..., parent_storage_id: _Optional[int] = ..., is_leaf: _Optional[_Union[_scailo_pb2.BOOL_FILTER, str]] = ..., family_id: _Optional[int] = ...) -> None: ...

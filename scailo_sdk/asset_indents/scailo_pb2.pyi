...
class ASSET_INDENT_ITEM_SORT_KEY(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ASSET_INDENT_ITEM_SORT_KEY_ID_UNSPECIFIED: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_CREATED_AT: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_MODIFIED_AT: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_APPROVED_ON: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_APPROVED_BY: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_APPROVER_ROLE_ID: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_FAMILY_ID: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]
    ASSET_INDENT_ITEM_SORT_KEY_QUANTITY: _ClassVar[ASSET_INDENT_ITEM_SORT_KEY]

class ASSET_INDENT_ITEM_STATUS(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ASSET_INDENT_ITEM_STATUS_ANY_UNSPECIFIED: _ClassVar[ASSET_INDENT_ITEM_STATUS]
    ASSET_INDENT_ITEM_STATUS_APPROVED: _ClassVar[ASSET_INDENT_ITEM_STATUS]
    ASSET_INDENT_ITEM_STATUS_UNAPPROVED: _ClassVar[ASSET_INDENT_ITEM_STATUS]

class ASSET_INDENT_SORT_KEY(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ASSET_INDENT_SORT_KEY_ID_UNSPECIFIED: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_CREATED_AT: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_MODIFIED_AT: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_APPROVED_ON: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_APPROVED_BY: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_APPROVER_ROLE_ID: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_COMPLETED_ON: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_REFERENCE_ID: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_FINAL_REF_NUMBER: _ClassVar[ASSET_INDENT_SORT_KEY]
    ASSET_INDENT_SORT_KEY_LOCATION_ID: _ClassVar[ASSET_INDENT_SORT_KEY]
ASSET_INDENT_ITEM_SORT_KEY_ID_UNSPECIFIED: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_CREATED_AT: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_MODIFIED_AT: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_APPROVED_ON: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_APPROVED_BY: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_APPROVER_ROLE_ID: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_FAMILY_ID: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_SORT_KEY_QUANTITY: ASSET_INDENT_ITEM_SORT_KEY
ASSET_INDENT_ITEM_STATUS_ANY_UNSPECIFIED: ASSET_INDENT_ITEM_STATUS
ASSET_INDENT_ITEM_STATUS_APPROVED: ASSET_INDENT_ITEM_STATUS
ASSET_INDENT_ITEM_STATUS_UNAPPROVED: ASSET_INDENT_ITEM_STATUS
ASSET_INDENT_SORT_KEY_ID_UNSPECIFIED: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_CREATED_AT: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_MODIFIED_AT: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_APPROVED_ON: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_APPROVED_BY: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_APPROVER_ROLE_ID: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_COMPLETED_ON: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_REFERENCE_ID: ASSET_INDENT_SORT_KEY
ASSET_INDENT_SORT_KEY_FINAL_REF_NUMBER: ASSET_INDENT_SORT_KEY
...
class AssetIndentItemsSearchRequest(_message.Message):
    ...
    sort_key: ASSET_INDENT_ITEM_SORT_KEY
    entity_uuid: str
...
class AssetIndentsServicePaginatedItemsResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[AssetIndentItem]
...
class AssetIndentsServicePaginationReq(_message.Message):
    ...
    offset: int
    sort_order: _scailo_pb2.SORT_ORDER
    sort_key: ASSET_INDENT_SORT_KEY
    status: _scailo_pb2.STANDARD_LIFECYCLE_STATUS
...
class AssetIndentsServicePaginationResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[AssetIndent]

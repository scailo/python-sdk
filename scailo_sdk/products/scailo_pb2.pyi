...
class PRODUCT_REF_FROM(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    PRODUCT_REF_FROM_ANY_UNSPECIFIED: _ClassVar[PRODUCT_REF_FROM]
    PRODUCT_REF_FROM_INITIAL_STOCK: _ClassVar[PRODUCT_REF_FROM]
    PRODUCT_REF_FROM_PRODUCTION_PLAN: _ClassVar[PRODUCT_REF_FROM]
PRODUCT_REF_FROM_ANY_UNSPECIFIED: PRODUCT_REF_FROM
PRODUCT_REF_FROM_INITIAL_STOCK: PRODUCT_REF_FROM
PRODUCT_REF_FROM_PRODUCTION_PLAN: PRODUCT_REF_FROM

class ProductsServiceCreateRequest(_message.Message):
...
class ProductsServiceSendToStoreRequest(_message.Message):
...
class ProductsServicePaginationResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[Product]
    def __init__(self, count: _Optional[int] = ..., offset: _Optional[int] = ..., total: _Optional[int] = ..., payload: _Optional[_Iterable[_Union[Product, _Mapping]]] = ...) -> None: ...

class ProductsServiceFilterReq(_message.Message):
    __slots__ = ("is_active", "count", "offset", "sort_order", "sort_key", "creation_timestamp_start", "creation_timestamp_end", "modification_timestamp_start", "modification_timestamp_end", "entity_uuid", "status", "store_intake_at_start", "store_intake_at_end", "discarded_at_start", "discarded_at_end", "parent_ref_id", "ref_from", "ref_id", "family_id", "code", "internal_item_code", "hash", "quantity_remaining_min", "quantity_remaining_max", "secondary_uom_id", "shelf_life_timestamp_start", "shelf_life_timestamp_end", "warranty_timestamp_start", "warranty_timestamp_end", "store_id", "storage_id", "is_qc_report_public", "location_id", "form_data")
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    SORT_ORDER_FIELD_NUMBER: _ClassVar[int]
...
class ProductsServiceSearchAllReq(_message.Message):

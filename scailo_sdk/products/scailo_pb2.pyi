...
class ProductsServiceFilterReq(_message.Message):
    __slots__ = ("is_active", "count", "offset", "sort_order", "sort_key", "creation_timestamp_start", "creation_timestamp_end", "modification_timestamp_start", "modification_timestamp_end", "entity_uuid", "status", "store_intake_at_start", "store_intake_at_end", "discarded_at_start", "discarded_at_end", "parent_ref_id", "ref_from", "ref_id", "family_id", "code", "internal_item_code", "hash", "quantity_remaining_min", "quantity_remaining_max", "secondary_uom_id", "shelf_life_timestamp_start", "shelf_life_timestamp_end", "warranty_timestamp_start", "warranty_timestamp_end", "store_id", "storage_id", "is_qc_report_public", "location_id")
    IS_ACTIVE_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    SORT_ORDER_FIELD_NUMBER: _ClassVar[int]

...
class SKILL_GROUP_ITEM_INPUT_VALUE_TYPE(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_ANY_UNSPECIFIED: _ClassVar[SKILL_GROUP_ITEM_INPUT_VALUE_TYPE]
    SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_NUMBER_ABSOLUTE: _ClassVar[SKILL_GROUP_ITEM_INPUT_VALUE_TYPE]
    SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_NUMBER_PERCENTAGE: _ClassVar[SKILL_GROUP_ITEM_INPUT_VALUE_TYPE]
    SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_TEXT_INPUT: _ClassVar[SKILL_GROUP_ITEM_INPUT_VALUE_TYPE]
    SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_TEXT_DROPDOWN: _ClassVar[SKILL_GROUP_ITEM_INPUT_VALUE_TYPE]

class SKILL_GROUP_SORT_KEY(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    SKILL_GROUP_SORT_KEY_ID_UNSPECIFIED: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_CREATED_AT: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_MODIFIED_AT: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_APPROVED_ON: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_APPROVED_BY: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_APPROVER_ROLE_ID: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_COMPLETED_ON: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_NAME: _ClassVar[SKILL_GROUP_SORT_KEY]
    SKILL_GROUP_SORT_KEY_ROLE_ID: _ClassVar[SKILL_GROUP_SORT_KEY]
SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_ANY_UNSPECIFIED: SKILL_GROUP_ITEM_INPUT_VALUE_TYPE
SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_NUMBER_ABSOLUTE: SKILL_GROUP_ITEM_INPUT_VALUE_TYPE
SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_NUMBER_PERCENTAGE: SKILL_GROUP_ITEM_INPUT_VALUE_TYPE
SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_TEXT_INPUT: SKILL_GROUP_ITEM_INPUT_VALUE_TYPE
SKILL_GROUP_ITEM_INPUT_VALUE_TYPE_TEXT_DROPDOWN: SKILL_GROUP_ITEM_INPUT_VALUE_TYPE
SKILL_GROUP_SORT_KEY_ID_UNSPECIFIED: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_CREATED_AT: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_MODIFIED_AT: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_APPROVED_ON: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_APPROVED_BY: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_APPROVER_ROLE_ID: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_COMPLETED_ON: SKILL_GROUP_SORT_KEY
SKILL_GROUP_SORT_KEY_NAME: SKILL_GROUP_SORT_KEY
...
class SkillsGroupsServiceItemCreateRequest(_message.Message):
    ...
    skill_group_id: int
    skill_param_id: int
    input_value_type: SKILL_GROUP_ITEM_INPUT_VALUE_TYPE
...
class SkillsGroupsServicePaginationResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[SkillGroup]
...
class SkillsGroupsServiceSearchAllReq(_message.Message):
    ...
    status: _scailo_pb2.STANDARD_LIFECYCLE_STATUS
    search_key: str
    def __init__(self, is_active: _Optional[_Union[_scailo_pb2.BOOL_FILTER, str]] = ..., count: _Optional[int] = ..., offset: _Optional[int] = ..., sort_order: _Optional[_Union[_scailo_pb2.SORT_ORDER, str]] = ..., sort_key: _Optional[_Union[SKILL_GROUP_SORT_KEY, str]] = ..., entity_uuid: _Optional[str] = ..., status: _Optional[_Union[_scailo_pb2.STANDARD_LIFECYCLE_STATUS, str]] = ..., search_key: _Optional[str] = ...) -> None: ...

...
class VISITATION_SORT_KEY(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    VISITATION_SORT_KEY_ID_UNSPECIFIED: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_CREATED_AT: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_MODIFIED_AT: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_APPROVED_ON: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_APPROVED_BY: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_APPROVER_ROLE_ID: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_COMPLETED_ON: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_REFERENCE_ID: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_FINAL_REF_NUMBER: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_USER_ID: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_ASSOCIATE_ID: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_ENTRY_TIMESTAMP: _ClassVar[VISITATION_SORT_KEY]
    VISITATION_SORT_KEY_EXIT_TIMESTAMP: _ClassVar[VISITATION_SORT_KEY]
VISITATION_SORT_KEY_ID_UNSPECIFIED: VISITATION_SORT_KEY
VISITATION_SORT_KEY_CREATED_AT: VISITATION_SORT_KEY
VISITATION_SORT_KEY_MODIFIED_AT: VISITATION_SORT_KEY
VISITATION_SORT_KEY_APPROVED_ON: VISITATION_SORT_KEY
VISITATION_SORT_KEY_APPROVED_BY: VISITATION_SORT_KEY
VISITATION_SORT_KEY_APPROVER_ROLE_ID: VISITATION_SORT_KEY
VISITATION_SORT_KEY_COMPLETED_ON: VISITATION_SORT_KEY
VISITATION_SORT_KEY_REFERENCE_ID: VISITATION_SORT_KEY
VISITATION_SORT_KEY_FINAL_REF_NUMBER: VISITATION_SORT_KEY
VISITATION_SORT_KEY_USER_ID: VISITATION_SORT_KEY
VISITATION_SORT_KEY_ASSOCIATE_ID: VISITATION_SORT_KEY
VISITATION_SORT_KEY_ENTRY_TIMESTAMP: VISITATION_SORT_KEY
...
class VisitationsServicePaginationResponse(_message.Message):
    ...
    offset: int
    total: int
    payload: _containers.RepeatedCompositeFieldContainer[Visitation]

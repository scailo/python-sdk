...
class SalesInvoicesServiceClient:
    ...
    def call_update_sales_invoice_item_specifications(
        self, req: sales_invoices.scailo_pb2.SalesInvoicesServiceItemSpecificationsUpdateRequest,extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None
    ) -> UnaryOutput[base.scailo_pb2.IdentifierResponse]:
        """Low-level method to call UpdateSalesInvoiceItemSpecifications, granting access to errors and metadata"""
        url = self.base_url + "/Scailo.SalesInvoicesService/UpdateSalesInvoiceItemSpecifications"
        return self._connect_client.call_unary(url, req, base.scailo_pb2.IdentifierResponse,extra_headers, timeout_seconds)


    def update_sales_invoice_item_specifications(
        self, req: sales_invoices.scailo_pb2.SalesInvoicesServiceItemSpecificationsUpdateRequest,extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None
    ) -> base.scailo_pb2.IdentifierResponse:
        response = self.call_update_sales_invoice_item_specifications(req, extra_headers, timeout_seconds)
        err = response.error()
        if err is not None:
            raise err
        msg = response.message()
...
class AsyncSalesInvoicesServiceClient:
    ...
    async def call_update_sales_invoice_item_specifications(
        self, req: sales_invoices.scailo_pb2.SalesInvoicesServiceItemSpecificationsUpdateRequest,extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None
    ) -> UnaryOutput[base.scailo_pb2.IdentifierResponse]:
        """Low-level method to call UpdateSalesInvoiceItemSpecifications, granting access to errors and metadata"""
        url = self.base_url + "/Scailo.SalesInvoicesService/UpdateSalesInvoiceItemSpecifications"
    ...
    async def update_sales_invoice_item_specifications(
        self, req: sales_invoices.scailo_pb2.SalesInvoicesServiceItemSpecificationsUpdateRequest,extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None
    ) -> base.scailo_pb2.IdentifierResponse:
        response = await self.call_update_sales_invoice_item_specifications(req, extra_headers, timeout_seconds)
        err = response.error()
        if err is not None:
            raise err
        msg = response.message()
...
class SalesInvoicesServiceProtocol(typing.Protocol):
    ...
    def modify_sales_invoice_item(self, req: ClientRequest[sales_invoices.scailo_pb2.SalesInvoicesServiceItemUpdateRequest]) -> ServerResponse[base.scailo_pb2.IdentifierResponse]:
        ...
    def update_sales_invoice_item_specifications(self, req: ClientRequest[sales_invoices.scailo_pb2.SalesInvoicesServiceItemSpecificationsUpdateRequest]) -> ServerResponse[base.scailo_pb2.IdentifierResponse]:
        ...
...
def wsgi_sales_invoices_service(implementation: SalesInvoicesServiceProtocol) -> WSGIApplication:
    ...
    app.register_unary_rpc("/Scailo.SalesInvoicesService/UpdateSalesInvoiceItemSpecifications", implementation.update_sales_invoice_item_specifications, sales_invoices.scailo_pb2.SalesInvoicesServiceItemSpecificationsUpdateRequest)
